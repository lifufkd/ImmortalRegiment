...
from src.schemas.military_ranks import AddMilitaryRank
from src.repository.wars import select_wars, insert_wars
from src.repository.military_ranks import select_military_ranks, insert_military_ranks
