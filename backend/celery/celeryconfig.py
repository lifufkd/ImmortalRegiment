...
from backend.api.utilities.config import redis_settings
...
beat_schedule = {
    'delete_pending_heroes_every_week': {
        'task': 'backend.api.tasks.tasks.clean_pending_application',
        'schedule': crontab(day_of_week="1")
    },
    'delete_rejected_heroes_every_day': {
        'task': 'backend.api.tasks.tasks.clean_rejected_application',
